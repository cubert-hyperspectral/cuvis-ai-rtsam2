...
- Security: refreshed the `aiohttp` (3.14.3), `cryptography` (50.0.0), `gitpython` (3.1.59), and `pip` (26.2) locks, clearing the freshly published advisories that failed the CI security scan on main.
## 0.2.1 - 2026-08-20
